...
const seraphMonitorPlugin = async () =>
  await import(/* webpackChunkName: "zainfoSeraphMonitorPlugin" */ 'app/plugins/datasource/seraph-monitor/module');
...
const builtInPlugins: any = {
  ...
  'app/plugins/datasource/seraph-monitor/module': seraphMonitorPlugin,
