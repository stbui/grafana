...
const seraphMonitorPlugin = async () =>
  await import(/* webpackChunkName: "seraphMonitorPlugin" */ 'app/plugins/datasource/seraph-monitor-datasource/module');
...
const builtInPlugins: any = {
  ...
  'app/plugins/datasource/seraph-monitor-datasource/module': seraphMonitorPlugin,
