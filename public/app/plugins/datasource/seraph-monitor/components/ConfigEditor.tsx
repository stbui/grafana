  ...
  renderInflux1x() {
    ...
    return (
      <div>
        ...
        <h3 className="page-heading">Seraph</h3>
        <div className="gf-form-group">
          <div className="gf-form-inline">
            <div className="gf-form">
              <InlineFormLabel className="width-10">HTTP API</InlineFormLabel>
              <div className="width-20">
                <Input
                  className="width-20"
                  value={options.jsonData.seraphApi || ''}
                  onChange={onUpdateDatasourceJsonDataOption(this.props, 'seraphApi')}
                />
              </div>
            </div>
          </div>
